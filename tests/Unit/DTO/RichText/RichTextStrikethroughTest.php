...
it('export all properties', function() {
    $dto = RichTextStrikethrough::fromData([
        'type' => 'strikethrough',
        'text' => 'Hello world',
    ]);
